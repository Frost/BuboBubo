    ...
    class TableRenderer < Renderer
      def render
        ...
        definitions.each do |definition|
          ...
          elsif definition[:type] == :erb_actions && definition[:options][:label]
            concat definition[:options][:label]
          end
      ...
      def table_options
        ...
        options[:html_options][:cellpadding] ||= 0
        options[:html_options][:cellspacing] ||= 0
